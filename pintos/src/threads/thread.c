...
void check_priority (void)
{
  ...
  if (thread_current()->priority < t->priority)		//if a change in the state of the ready_list (addition or removal of a thread) caused this check function to be called.
  {
    thread_yield();
  }
}
